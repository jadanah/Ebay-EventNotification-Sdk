...
namespace Ebay.EventNotification.Sdk.Client
{
    public class ClientConstants
    {
        ...
        {
            { Constants.Constants.Production, "https://api.ebay.com/commerce/notification/v1/public_key/" },
            { Constants.Constants.Sandbox, "https://api.sandbox.ebay.com/commerce/notification/v1/public_key/" }
        };
        ...
        {
            EndPoints.TryGetValue(key, out var url);
            return url;
        }
    }
}